...
# permission, with 4 corresponding to read, 2 to write, and 1 to execute. Or it 
# can be written with a string using the letters r, w, and x or - when the permission 
# is not granted.
#  For example: 
...
def octal_to_string_Question(octal):
    pass
    result = ""
